...
This is meant as a learning and research project, not a production trading system.
...
You run this whenever you want more data.
...
You can repeat this as new headlines become available.
...
- Headlines are pulled from Google News and can be noisy
- This project uses a small dataset by default
- Results can change a lot with limited data
- This is for exploration and learning, not live trading
...
- Add a buy/sell strategy and compute P&L
- Ignore weak sentiment days
- Focus only on earnings-related news
- Add more stocks automatically
